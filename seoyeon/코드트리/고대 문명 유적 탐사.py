...
def rotate():
    ...
    for i in range(1,4):
        for j in range(1,4):
            ...
            sum180,lst180,maps180 = rotate180(i,j)
            sum270,lst270,maps270 = rotate270(i,j)
            #print(i,j,"sum!",sum90,sum180,sum270,"FIRST_SUM",first_sum,sum_rotate_n)
            #90도 회전
            if sum90 >= first_sum:
                if sum90>first_sum:
                    first_sum = sum90
...
def rotate():
    ...
    for i in range(1,4):
        for j in range(1,4):
            ...
            sum180,lst180,maps180 = rotate180(i,j)
            sum270,lst270,maps270 = rotate270(i,j)
            #print(i,j,"sum!",sum90,sum180,sum270,"FIRST_SUM",first_sum,sum_rotate_n,pos)
            #90도 회전
            if sum90 >= first_sum:
                if sum90>first_sum:
                    first_sum = sum90
    ...
    for i in range(1,4):
        for j in range(1,4):
            ...
            if sum270 > first_sum:
                ...
                sum_rotate_n = 270    
                pos = [i,j]
            if sum270==first_sum and sum_rotate_n==270:
                if pos[1]>j or (pos[1]==j and pos[0]>i):
                    first_sum = sum270
                    lst = lst270
                    maps_result = maps270
                    sum_rotate_n = 270    
